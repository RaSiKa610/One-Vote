export const POLITICAL_ERAS = [
  {
    ...
    descKey: 'era1_desc',
    color: '#00BFFF',
    wikiUrl: 'https://en.wikipedia.org/wiki/History_of_the_Republic_of_India',
    parties: [
      {
        nameKey: 'era1_party1',
  ...
  },
  {
    ...
    descKey: 'era2_desc',
    color: '#E74C3C',
    wikiUrl: 'https://en.wikipedia.org/wiki/The_Emergency_(India)',
    parties: [
      {
        nameKey: 'era2_party1',
    ...
    movements: [
      {
        titleKey: 'era2_movement1_title',
        descKey: 'era2_movement1_desc'
      }
    ],
    leaders: [
      {
  ...
  },
  {
    ...
    descKey: 'era3_desc',
    color: '#8E44AD',
    wikiUrl: 'https://en.wikipedia.org/wiki/Economic_liberalisation_in_India',
    parties: [
      {
        nameKey: 'era3_party1',
  ...
  },
  {
    ...
    descKey: 'era4_desc',
    color: '#FF9933',
    wikiUrl: 'https://en.wikipedia.org/wiki/2024_Indian_general_election',
    parties: [
      {
        nameKey: 'era4_party1',
    ...
    movements: [
      {
        titleKey: 'era4_movement1_title',
        descKey: 'era4_movement1_desc'
      }
    ],
    leaders: [
      {
